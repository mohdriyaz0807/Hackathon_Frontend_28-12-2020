...
import {Paper , Grid ,makeStyles,MenuItem,FormControl,InputLabel,Select,Box} from '@material-ui/core';
...
const useStyles = makeStyles((theme) => ({
  ...
  return (
    <div className={classes.root}>
      ...
      <Paper className={classes.paper}><PizzaBase /></Paper>
        </Grid>
        <Grid item xs={12} sm={6} lg={4} >
      ...
      <Paper className={classes.paper}><Sauce/></Paper>
        </Grid>
        <Grid item xs={12} sm={6} lg={4} >
      ...
      <Paper className={classes.paper}><Cheese/></Paper>
        </Grid>
        <Grid item xs={12} sm={6} lg={4} >
      ...
      <Paper className={classes.paper}><Veggies/></Paper>
        </Grid>
        <Grid item xs={12} sm={6} lg={4} >
